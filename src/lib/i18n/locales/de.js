...
export default {
  ...
  features: {
    ...
    items: [
      ...
      { tag: '80+ SPIELE BEREIT', title: 'IN SEKUNDEN\nEINGERICHTET.', body: 'Vorlagen für 80+ Spiele — vier Spielarten von modded Minecraft, Stardew, Skyrim, Palworld, Elden Ring — plus sieben Emulatoren. Wähl, welche Dateien zählen, und überspring die Screenshots. Wenn es in einen Ordner speichert, funktioniert es.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'FUNKTIONIERT DAS MIT EMULATOREN ODER KONSOLEN-SPIELSTÄNDEN?', a: 'Emulatoren, absolut — RetroArch, Dolphin, PCSX2, DuckStation, PPSSPP, RPCS3 und Cemu haben alle Vorlagen, deine Save-States bekommen also endlich echten Versionsverlauf. Konsolen-Spielstände funktionieren nur, wenn du sie erst auf einen PC bekommst. Die App selbst läuft auf Windows und Linux.' },
      { q: 'WAS KOSTET ES?', a: 'Der Gratis-Plan ist echt und bleibt gratis: 20 MiB, dein eigener Bereich plus ein Team. Lifetime ist eine Einmalzahlung — 1 GiB pro Bereich, bis zu 3 Teams, direkt oder über Steam gekauft. Pro ist für große Crews: 5 GiB pro Bereich, 5 Teams, je 25 Plätze, Nur-Lese-Teilen-Codes. Auf keiner Stufe Gebühr pro Person.' },
      { q: 'KANN ICH ES HEUTE SCHON NUTZEN?', a: 'Ja — v1.0 ist da. Auf Steam ist es der Windows-Build; Linux gibt es als kostenlosen Direkt-Download hier auf der Seite. Einen Mac-Build gibt es noch nicht.' },
  ...
  meta: {
    ...
    description: 'Automatisches Cloud-Backup und voller Versionsverlauf für PC-Spielstände. Roll kaputte Spielstände zurück und teil co-op-Welten per Sperre. Funktioniert mit Minecraft, Stardew Valley, Elden Ring und 80+ Spielen. Gratis-Download für Windows und Linux.',
    ogTitle: 'Checkpoint64 — Nie wieder einen Spielstand verlieren, solo oder co-op',
    ogDescription: 'Nie wieder einen Spielstand verlieren. Automatische Backups, voller Versionsverlauf und co-op-Sperren, damit Freunde Welten teilen, ohne sich gegenseitig zu überschreiben. 80+ Spiele bereit. Gratis-Download — einmal zahlen für mehr Platz.',
    ...
    twitterDescription: 'Nie wieder einen Spielstand verlieren. Automatische Cloud-Backups, voller Versionsverlauf, co-op-Sperren. 80+ Spiele bereit. Gratis-Download für Windows und Linux.',
  ...
  jsonld: {
    ...
    softwareDescription: 'Automatisches Cloud-Backup, voller Versionsverlauf und co-op-Sperren für PC-Spielstände. Gratis-Plan inklusive; einmal zahlen für mehr Platz. Funktioniert von Haus aus mit Minecraft, Stardew Valley, Skyrim, Palworld, Elden Ring, Factorio, Valheim sowie 80+ weiteren Spielen und 7 Emulatoren.',
    featureList: [
      ...
      'Vorlagen für 80+ Spiele und 7 Emulatoren',
