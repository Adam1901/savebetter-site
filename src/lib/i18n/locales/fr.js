...
export default {
  ...
  features: {
    ...
    items: [
      ...
      { tag: '80+ JEUX PRÊTS', title: 'CONFIGURÉ EN\nQUELQUES SECONDES.', body: "Des préréglages pour 80+ jeux — quatre variantes de Minecraft moddé, Stardew, Skyrim, Palworld, Elden Ring — plus sept émulateurs. Choisissez les fichiers qui comptent et sautez les captures d'écran. Si ça sauvegarde dans un dossier, ça marche." },
  ...
  faq: {
    ...
    items: [
      { q: "QU'EST-CE QUI COMPTE COMME « SAUVEGARDE » ?", a: "Tout ce que votre jeu écrit sur votre disque dur. Checkpoint64 traite les fichiers d'un dossier comme une seule sauvegarde et les protège ensemble. Des préréglages pour 80+ jeux (et sept émulateurs) font la configuration pour vous ; pour le reste, pointez le dossier et choisissez les fichiers vous-même." },
      ...
      { q: 'ÇA MARCHE AVEC LES ÉMULATEURS OU LES SAUVEGARDES CONSOLE ?', a: "Les émulateurs, carrément — RetroArch, Dolphin, PCSX2, DuckStation, PPSSPP, RPCS3 et Cemu ont tous leur préréglage : vos save states ont enfin un vrai historique de versions. Les sauvegardes console ne marchent que si vous les amenez d'abord sur un PC. L'appli elle-même tourne sur Windows et Linux." },
      ...
      { q: "JE PEUX L'UTILISER DÈS AUJOURD'HUI ?", a: "Oui — la v1.0 est sortie. Sur Steam, c'est le build Windows ; Linux est en téléchargement direct gratuit depuis cette page. Il n'y a pas encore de build Mac." },
  ...
  meta: {
    ...
    description: "Backup cloud automatique et historique complet des versions pour vos sauvegardes de jeux PC. Restaurez les sauvegardes corrompues et partagez vos mondes co-op avec des verrous. Compatible Minecraft, Stardew Valley, Elden Ring et 80+ jeux. Téléchargement gratuit pour Windows et Linux.",
    ogTitle: 'Checkpoint64 — Ne perdez plus jamais une sauvegarde, solo ou co-op',
    ogDescription: "Ne perdez plus jamais une sauvegarde. Backups automatiques, historique complet des versions et verrous co-op pour que les amis partagent des mondes sans s'écraser. 80+ jeux prêts. Téléchargement gratuit — payez une fois pour plus d'espace.",
    ...
    twitterDescription: 'Ne perdez plus jamais une sauvegarde. Backups cloud automatiques, historique complet des versions, verrous co-op. 80+ jeux prêts. Téléchargement gratuit pour Windows et Linux.',
  ...
  jsonld: {
    ...
    featureList: [
      ...
      'Préréglages pour 80+ jeux et 7 émulateurs',
