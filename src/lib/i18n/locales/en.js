...
export default {
  ...
  features: {
    ...
    items: [
      ...
      { tag: '80+ GAMES READY', title: 'SET UP IN\nSECONDS.', body: 'Presets for 80+ games — four flavours of modded Minecraft, Stardew, Skyrim, Palworld, Elden Ring — plus seven emulators. Pick which files count and skip the screenshots. If it writes saves to a folder, it works.' },
  ...
  faq: {
    ...
    items: [
      { q: "WHAT COUNTS AS A 'SAVE'?", a: 'Whatever your game writes to your hard drive. Checkpoint64 treats the files in a folder as one save and backs them up together. Presets for 80+ games (and seven emulators) set this up for you; for anything else, point at the folder and pick the files yourself.' },
      ...
      { q: 'DOES THIS WORK FOR EMULATORS OR CONSOLE SAVES?', a: 'Emulators, absolutely — RetroArch, Dolphin, PCSX2, DuckStation, PPSSPP, RPCS3, and Cemu all have presets, so your save states finally get real version history. Console saves only work if you can get them onto a PC first. The app itself runs on Windows and Linux.' },
      ...
      { q: 'CAN I USE IT TODAY?', a: 'Yes — v1.0 is out. On Steam it’s the Windows build; Linux is a free direct download from this page. There’s no Mac build yet.' },
  ...
  meta: {
    ...
    description: 'Automatic cloud backup and full version history for PC game saves. Roll back corrupted saves and share co-op worlds with locks. Works with Minecraft, Stardew Valley, Elden Ring and 80+ games. Free download for Windows and Linux.',
    ogTitle: 'Checkpoint64 — Never Lose a Save Again, Solo or Co-op',
    ogDescription: 'Never lose a save again. Automatic backups, full version history, and co-op locks so friends can share worlds without overwriting each other. 80+ games ready. Free download — pay once for more space.',
    ...
    twitterDescription: 'Never lose a save again. Automatic cloud backups, full version history, co-op locks. 80+ games ready. Free download for Windows and Linux.',
  ...
  jsonld: {
    ...
    softwareDescription: 'Automatic cloud backup, full version history, and co-op locks for PC game saves. Free plan included; pay once for more space. Works with Minecraft, Stardew Valley, Skyrim, Palworld, Elden Ring, Factorio, Valheim, plus 80+ more games and 7 emulators out of the box.',
    featureList: [
      ...
      'Presets for 80+ games and 7 emulators',
